//duplicate of confirm_transfer.dart
...
class ServiceDetails extends StatelessWidget {
  ...
  ServiceDetails({Key? key, required this.amountTransferred,required this.accountNumber, required this.accountName}) : super(key: key);
           ...
           children: [
            ...
            Row(
              children: [
                ...
                Text('Amount Transferred: PHP $amountTransferred', style: TextStyle(
                  fontSize: 21,
                  fontWeight: FontWeight.w800,
                  fontFamily: 'avenir',
                ),),
            ...
            const SizedBox(height: 20,),
             Row(
              children: [
                ...
                Text('Account Name: $accountName', style: TextStyle(
                  fontSize: 21,
                  fontWeight: FontWeight.w800,
                  fontFamily: 'avenir',
                ),),
